...
class GridWorld10x10:
    def __init__(self):
        ...
        noise = 0.25
        self.action_success_prob = 1 - noise  # 0.75
        self.clockwise_prob = noise / 3
        self.counterclockwise_prob = noise / 3
        self.stay_prob = 1 - self.action_success_prob - self.clockwise_prob - self.counterclockwise_prob
